...
function renderColorsAndType1(pokemon) {
    ...
    if(pokemon._type1 == "grass") {
       ...
       let header = document.getElementById('header')
       header.style.background = 'rgb(120, 200, 80)'

       let footer = document.getElementById('footer')
       footer.style.background = 'rgb(120, 200, 80)'

       let type1 = document.querySelector('.type1')
       type1.style.background = 'rgb(120, 200, 80)'
    }
    ...
    if(pokemon._type1 == "poison") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(160, 64, 160)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(160, 64, 160)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(160, 64, 160)'
     ...
     if(pokemon._type1 == "fire") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(240, 128, 48)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(240, 128, 48)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(240, 128, 48)'
     ...
     if(pokemon._type1 == "flying") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(168, 144, 240)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(168, 144, 240)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(168, 144, 240)'
     }
     ...
     if(pokemon._type1 == "water") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(104, 144, 240)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(104, 144, 240)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(104, 144, 240)'
     }
     ...
     if(pokemon._type1 == "bug") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(168, 184, 32)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(168, 184, 32)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(168, 184, 32)'
     }
     ...
     if(pokemon._type1 == "normal") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(168, 168, 120)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(168, 168, 120)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(168, 168, 120)'
     }
     ...
     if(pokemon._type1 == "electric") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(248, 208, 48)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(248, 208, 48)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(248, 208, 48)'
     }
     ...
     if(pokemon._type1 == "ground") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(224, 192, 104)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(224, 192, 104)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(224, 192, 104)'
     }
     ...
     if(pokemon._type1 == "fairy") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(238, 153, 172)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(238, 153, 172)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(238, 153, 172)'
     }
     ...
     if(pokemon._type1 == "fighting") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(192, 48, 40)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(192, 48, 40)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(192, 48, 40)'
     }
     ...
     if(pokemon._type1 == "psychic") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(248, 88, 136)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(248, 88, 136)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(248, 88, 136)'
     }
     ...
     if(pokemon._type1 == "steel") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(184, 184, 208)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(184, 184, 208)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(184, 184, 208)'
     }
     ...
     if(pokemon._type1 == "ice") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(152, 216, 216)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(152, 216, 216)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(152, 216, 216)'
     }
     ...
     if(pokemon._type1 == "dragon") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(112, 56, 248)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(112, 56, 248)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(112, 56, 248)'
     }
     ...
     if(pokemon._type1 == "ghost") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(112, 88, 152)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(112, 88, 152)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(112, 88, 152)'
     }
     ...
     if(pokemon._type1 == "dark") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(112, 88, 72)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(112, 88, 72)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(112, 88, 72)'
     }
     ...
     if(pokemon._type1 == "rock") {
        ...
        let header = document.getElementById('header')
        header.style.background = 'rgb(184, 160, 56)'
 
        let footer = document.getElementById('footer')
        footer.style.background = 'rgb(184, 160, 56)'
 
        let type1 = document.querySelector('.type1')
        type1.style.background = 'rgb(184, 160, 56)'
     }
}
...
function renderType2(pokemon) {
    ...
    if(pokemon._type2 == "grass") {
       ...
       container.style.background = 'rgb(120, 200, 80)'
    }
    ...
    if(pokemon._type2 == "poison") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(160, 64, 160)'
     }
     ...
     if(pokemon._type2 == "fire") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(240, 128, 48)'
     }
     ...
     if(pokemon._type2 == "flying") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(168, 144, 240)'
     }
     ...
     if(pokemon._type2 == "water") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(104, 144, 240)'
     }
     ...
     if(pokemon._type2 == "bug") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(168, 184, 32)'
     }
     ...
     if(pokemon._type2 == "normal") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(168, 168, 120)'
     }
     ...
     if(pokemon._type2 == "electric") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(248, 208, 48)'
     }
     ...
     if(pokemon._type2 == "ground") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(224, 192, 104)'
     }
     ...
     if(pokemon._type2 == "fairy") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(238, 153, 172)'
     }
     ...
     if(pokemon._type2 == "fighting") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(192, 48, 40)'
     }
     ...
     if(pokemon._type2 == "psychic") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(248, 88, 136)'
     }
     ...
     if(pokemon._type2 == "steel") {
      ...
      let container = document.getElementById('container')
      container.style.background = 'rgb(184, 184, 208)'
   }
     ...
     if(pokemon._type2 == "ice") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(152, 216, 216)'
     }
     ...
     if(pokemon._type2 == "dragon") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(112, 56, 248)'
     }
     ...
     if(pokemon._type2 == "ghost") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(112, 88, 152)'
     }
     ...
     if(pokemon._type2 == "dark") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(112, 88, 72)'
     }
     ...
     if(pokemon._type2 == "rock") {
        ...
        let container = document.getElementById('container')
        container.style.background = 'rgb(184, 160, 56)'
     }
}
